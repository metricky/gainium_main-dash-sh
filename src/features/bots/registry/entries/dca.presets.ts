...
export const DCA_CREATE_WIDGETS: BotWidgetType[] = [
  'bot-chart',
  'create-bot',
  'backtests',
  'notes',
...
export const DCA_EDIT_WIDGETS: BotWidgetType[] = [
  'edit-bot-chart',
  'edit-bot',
  'backtests',
  'notes',
...
export const DCA_CREATE_LAYOUTS: BotWidgetLayoutMap = {
  'bot-chart': {
...
export const DCA_EDIT_LAYOUTS: BotWidgetLayoutMap = {
  'edit-bot-chart': {
    mobile: { w: 12, h: 6, x: 0, y: 0 },
    tablet: { w: 8, h: 8, x: 0, y: 0 },
    desktop: { w: 8, h: 8, x: 0, y: 0 },
